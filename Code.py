...
cv2.createTrackbar("Upper Hue", "Color detectors", 151, 180, setValues)
cv2.createTrackbar("Upper Sat", "Color detectors", 181, 255, setValues)
cv2.createTrackbar("Upper Val", "Color detectors", 255, 255, setValues)
cv2.createTrackbar("Lower Hue", "Color detectors", 32, 180, setValues)
cv2.createTrackbar("Lower Sat", "Color detectors", 49, 255, setValues)
cv2.createTrackbar("Lower Val", "Color detectors", 168, 255, setValues)
